...
// Forward-declare RHI shader interface for future Metal backend integration.
// MetalProgramObject will implement IProgramObject and use RHI::ShaderCompiler
// to translate GLSL->SPIR-V->MSL at load time (or load pre-compiled .metallib).
// See rts/Rendering/RHI/RHIShader.h and rts/Rendering/RHI/ShaderCompiler.h.
namespace RHI { class IRHIShader; }
...
namespace Shader {
	...
	public:
		...
		bool RemoveShaderObject(unsigned int soType);
	...
	public:
		...
		template<typename TV> inline void SetUniform1v(const char* name, const int count, const TV* v) { SetUniform1v(GetUniformState(name), count, v); }
		template<typename TV> inline void SetUniform2v(const char* name, const int count, const TV* v) { SetUniform2v(GetUniformState(name), count, v); }
		template<typename TV> inline void SetUniform3v(const char* name, const int count, const TV* v) { SetUniform3v(GetUniformState(name), count, v); }
		template<typename TV> inline void SetUniform4v(const char* name, const int count, const TV* v) { SetUniform4v(GetUniformState(name), count, v); }
		...
		/// variants with count param
		virtual void SetUniform1iv(int idx, int count, const int*   v) = 0;
		virtual void SetUniform2iv(int idx, int count, const int*   v) = 0;
		virtual void SetUniform3iv(int idx, int count, const int*   v) = 0;
		virtual void SetUniform4iv(int idx, int count, const int*   v) = 0;
		virtual void SetUniform1fv(int idx, int count, const float* v) = 0;
		virtual void SetUniform2fv(int idx, int count, const float* v) = 0;
		virtual void SetUniform3fv(int idx, int count, const float* v) = 0;
		virtual void SetUniform4fv(int idx, int count, const float* v) = 0;
	...
	protected:
		...
		virtual void SetUniform1v(UniformState* uState, int count, const int*   v) { SetUniform1iv(uState->GetLocation(), count, v); }
		virtual void SetUniform1v(UniformState* uState, int count, const float* v) { SetUniform1fv(uState->GetLocation(), count, v); }
		virtual void SetUniform2v(UniformState* uState, int count, const int*   v) { SetUniform2iv(uState->GetLocation(), count, v); }
		virtual void SetUniform2v(UniformState* uState, int count, const float* v) { SetUniform2fv(uState->GetLocation(), count, v); }
		virtual void SetUniform3v(UniformState* uState, int count, const int*   v) { SetUniform3iv(uState->GetLocation(), count, v); }
		virtual void SetUniform3v(UniformState* uState, int count, const float* v) { SetUniform3fv(uState->GetLocation(), count, v); }
		virtual void SetUniform4v(UniformState* uState, int count, const int*   v) { SetUniform4iv(uState->GetLocation(), count, v); }
		virtual void SetUniform4v(UniformState* uState, int count, const float* v) { SetUniform4fv(uState->GetLocation(), count, v); }
	...
	public:
		...
		/// variants with count param
		void SetUniform1iv(int idx, int count, const int*   v) override { SetUniform1i(idx, v[0]); }
		void SetUniform2iv(int idx, int count, const int*   v) override { SetUniform2iv(idx, v); }
		void SetUniform3iv(int idx, int count, const int*   v) override { SetUniform3iv(idx, v); }
		void SetUniform4iv(int idx, int count, const int*   v) override { SetUniform4iv(idx, v); }
		void SetUniform1fv(int idx, int count, const float* v) override { SetUniform1f(idx, v[0]); }
		void SetUniform2fv(int idx, int count, const float* v) override { SetUniform2fv(idx, v); }
		void SetUniform3fv(int idx, int count, const float* v) override { SetUniform3fv(idx, v); }
		void SetUniform4fv(int idx, int count, const float* v) override { SetUniform4fv(idx, v); }
