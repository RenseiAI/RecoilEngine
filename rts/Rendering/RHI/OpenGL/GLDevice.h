...
public:
	...
	std::unique_ptr<IRHITexture> WrapExistingTexture(uint32_t glTextureId, TextureType type, TextureFormat format, uint32_t width, uint32_t height, uint32_t depthOrLayers, uint32_t mipLevels) override;
